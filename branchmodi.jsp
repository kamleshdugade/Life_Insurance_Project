...
<form name="form1" action="./Branchmodify.jsp">
    ...
    <table width="401" border="3" align="center" cellpadding="3">
        <div>
            <td width="215">
                <div align="center"><font size="5" face="Times New Roman, Times, serif"><em><strong>Select
                    Branch ID</strong></em></font><strong><label>
                    <div align="center"><span style="font-size: large; font-family: Times New Roman, Times, serif; "></span></div>
                </label></strong></div>
            </td>
        </div>
